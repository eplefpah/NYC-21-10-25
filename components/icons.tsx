...
export const CrosshairIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <IconWrapper {...props}>
        <path fillRule="evenodd" d="M10 5a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0110 5zM10 15a.75.75 0 01-.75-.75v-1.5a.75.75 0 011.5 0v1.5a.75.75 0 01-.75.75zM14.25 10a.75.75 0 01-.75.75h-1.5a.75.75 0 010-1.5h1.5a.75.75 0 01.75.75zM7.25 10a.75.75 0 01-.75.75h-1.5a.75.75 0 010-1.5h1.5a.75.75 0 01.75.75zM10 18a8 8 0 100-16 8 8 0 000 16zM10 16.5a6.5 6.5 0 100-13 6.5 6.5 0 000 13z" clipRule="evenodd" />
    </IconWrapper>
);

export const BicycleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <IconWrapper {...props}>
    <path fillRule="evenodd" d="M15.5 4.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zm-11 0a2.5 2.5 0 100-5 2.5 2.5 0 000 5zm11 .5a3.5 3.5 0 100-7 3.5 3.5 0 000 7zM4.5 5a3.5 3.5 0 100-7 3.5 3.5 0 000 7zM12.5 8.5a.75.75 0 01-.75.75h-4.5a.75.75 0 010-1.5h4.5a.75.75 0 01.75.75zm-3.13 1.015a.75.75 0 01.44 1.305l-2.5 1.5a.75.75 0 01-.88-1.22l2.5-1.5a.75.75 0 01.44-.085zM8 12.5a.75.75 0 000 1.5h.392l-1.37 2.74a.75.75 0 001.336.67l2-4a.75.75 0 00-1.118-1.12L8.392 14H8a.75.75 0 00-.75-.75h-.392a.75.75 0 00-.75.75z" clipRule="evenodd" />
  </IconWrapper>
);